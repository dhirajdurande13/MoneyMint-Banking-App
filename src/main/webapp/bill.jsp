...
<body>
   ...
   recharge2 reg=null;
	 ...
	 reg=(recharge2)session.getAttribute("result");
    ...
    <nav class="navbar navbar-expand-md bg-body-secondary">
      ...
      <main class="main">
     	 <div class="img">
    <img src="./rechargeForm.jpg" alt="">
  </div>
       
         <div class="form"> 
   <div class="row mt-2">
   <div class="col-8 offset-2">
   <h3 class="text">Recharge!</h3>
  ...
  <table>
     ...
     <label for="username"><b>Username</b></label>
  	...
  	<input type="text" id="username" name="username" class="input" required value="<%= reg.getUsername() %>">
	 
	     <label for="password"><b>Password</b> </label>
  	<input type="text" id="password" name="password" class="input" required value="<%= reg.getPassword() %>">
  	...
  	<input type="number" id="mobile" name="mobile" required
  	 ...
  	 <label for="exampleInputPassword1" class="form-label" name="operator"><b>Operator</b></label>
            <input type="text" id="operator" name="operator" class="input" required value="<%= reg.getOperator() %>">
            
             <label for="plans"><b>Amount</b></label>
     
  	<input type="text" id="plans" name="plans" class="input" required value="<%= reg.getPlan() %>">
