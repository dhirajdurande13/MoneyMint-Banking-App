...
<body>
   ...
   credit crd=null;
	 ...
	 crd=(credit)session.getAttribute("result");
   ...
   <h4 class="text">Withdrwal successful!</h4>
   </div>
    <form action="">
  <table>
     ...
     <label for="username"><b>Username</b></label>
  	...
  	<input type="text" id="username" name="username" class="input" required value="<%= crd.getUsername() %>" disabled>
	 
	    
             <label for="plans"><b>Amount Withdrawed</b></label>
     
  	<input type="text" id="plans" name="plans" class="input" required value="<%= crd.getAccBal() %>" disabled>
	 <br>
  	<h5>Thank you.</h5>
  	 <br>
