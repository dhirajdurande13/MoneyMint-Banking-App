        ...
        <div class="row">
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <div class="parent">
                    ...
                    <img src="./Jio.png" alt="jio" class="jio">
                </div>
                <form action="recharge2Controller">
                    ...
                    <input type="hidden" id="operator" name="operator" required value="Jio">
                    <input type="hidden" id="plans" name="plans" required value="15">
                    <p>VALIDITY : <b>Active Plan</b></p>
                    <p>DATA:<b>1 GB</b></p>
                    <p>Benefit of 1GB with validity of active plan.</p>
            ...
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <input type="hidden" id="mobile" name="mobile" required value="<%= reg.getMobile() %>">
                    <input type="hidden" id="operator" name="operator" required value="Jio">
                    <input type="hidden" id="plans" name="plans" required value="61">
                    <p>VALIDITY : <b>Active Plan</b></p>
                    <p>DATA:<b>6 GB</b></p>
                    <p>Benefit of 6GB with validity of active plan.</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
            ...
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <div class="parent">
                    <h5 class="card-title"><b>₹ 222</b></h5>
                    <img src="./Jio.png" alt="jio" class="jio">
                </div>
                <form action="recharge2Controller">
                    <input type="hidden" id="username" name="username" class="input" required
                    ...
                    <input type="hidden" id="mobile" name="mobile" required value="<%= reg.getMobile() %>">
                    <input type="hidden" id="operator" name="operator" required value="Jio">
                    <input type="hidden" id="plans" name="plans" required value="222">
                    <p>VALIDITY : <b>Active Plan</b></p>
                    <p>DATA:<b>50 GB</b></p>
                    <p>Benefit of 50GB with validity of active plan.</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
             ...
             <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <div class="parent">
                    <h5 class="card-title"><b>₹ 239</b></h5>
                    <img src="./Jio.png" alt="jio" class="jio">
                </div>
                <form action="recharge2Controller">
                    <input type="hidden" id="username" name="username" class="input" required
                    ...
                    <input type="hidden" id="mobile" name="mobile" required value="<%= reg.getMobile() %>">
                    <input type="hidden" id="operator" name="operator" required value="Jio">
                    <input type="hidden" id="plans" name="plans" required value="239">
                    <p>VALIDITY : <b>28 days</b></p>
                    <p>DATA:<b>1.5 GB/Day</b></p>
                    <p>Unlimited calling for 28 days with 1.5GB daily data</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
	 ...
	 <div class="row">
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <p>Unlimited calling for 28 days with 2GB daily data</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
            ...
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <div class="parent">
                    <h5 class="card-title"><b>₹ 666</b></h5>
                    <img src="./Jio.png" alt="jio" class="jio">
                </div>
                <form action="recharge2Controller">
                    <input type="hidden" id="username" name="username" class="input" required
                    ...
                    <input type="hidden" id="mobile" name="mobile" required value="<%= reg.getMobile() %>">
                    <input type="hidden" id="operator" name="operator" required value="Jio">
                    <input type="hidden" id="plans" name="plans" required value="666">
            ...
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <input type="hidden" id="mobile" name="mobile" required value="<%= reg.getMobile() %>">
                    <input type="hidden" id="operator" name="operator" required value="Jio">
                    <input type="hidden" id="plans" name="plans" required value="749">
