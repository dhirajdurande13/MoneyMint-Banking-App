        ...
        <div class="row">
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <div class="parent">
                    ...
                    <img src="./vi.png" alt="vi" class="jio">
                </div>
                <form action="recharge2Controller">
                    ...
                    <input type="hidden" id="operator" name="operator" required value="Vi">
            ...
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <p>DATA : <b>Night Free Data</b></p>
                    <p>Benefit of unlimited night Data for 7 days.</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
            ...
            <div class="card col-3" style="width: 15rem; height:15rem">
             ...
             <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <p>Unlimited calling for 28 days with 1.5 GB daily data with Binge all night</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
	 ...
	 <div class="row">
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <p>Unlimited calling for 56 days with 2GB daily data Binge all night.</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
            ...
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <p>DATA : <b>1.5 GB/Day</b></p>
                    <p>Unlimited calling for 84 days with 1.5GB daily data Binge all night</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
            ...
            <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <p>DATA : <b>2 GB/Day</b></p>
                    <p>Unlimited calling for 90 days with 2GB daily data Binge all night</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
             ...
             <div class="card col-3" style="width: 15rem; height:15rem">
                ...
                <form action="recharge2Controller">
                    ...
                    <p>Unlimited calling for 365 days with 2.5GB daily data Binge all night</p>
                    <button type="submit" class="submit">Recharge</button>
                </form>
