...
<body>
    <nav class="navbar navbar-expand-md bg-body-secondary">
      ...
      <main>
        <div class="content">
            <h1><b>Welcome to MoneyMint!</b></h1>
            <p>MoneyMint is committed to delivering a cashless banking experience <br> that empowers you to manage your finances effortlessly. <br> Start exploring, start banking!</p>
            <div class="button">
